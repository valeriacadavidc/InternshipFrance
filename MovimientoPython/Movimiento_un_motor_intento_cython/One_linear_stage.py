...
#from optimized_functions import collect_data_cython
...
def main():
    ...
    try:
        ...
        parameters9=[2,0,25,200] #velocity,initial position,final position, frecuency
        ...
        path=r"C:\\Users\\valeria.cadavid\\Documents\\RepositorioCodigos\\Resultados\\Movimiento\\Taguchi_funcion_schedule\\1"
        ...
        name=f"v_{parameters[0]}_pi_{parameters[1]}_pf_{parameters[2]}_freq_{parameters[3]}_rep_{i}_profiler"
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
            ...
            #p1=executor.submit(collect_data_cython,thorlabs_devices.devices,sample_time=sample_time, num_samples=num_samples, path=path, name=name)
